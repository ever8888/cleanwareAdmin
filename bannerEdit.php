...
?>
  ...
  <img id="preimg3" onclick="opq()" width="500px" height="150px" src="<?php echo 'images/'.$erow['banner_img']; ?>"><br><br>
  <input type="file"  name="waimg" onchange="document.getElementById('preimg3').src = window.URL.createObjectURL(this.files[0])">

	 <script>
	 function opq(){
		 var img2=document.getElementById("preimg3");
