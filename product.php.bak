...
<?php include 'sidenav.php'; ?>
  ...
  <section class="home-section">
    ...
    <thead>
        <tr>
            <th>Product Image</th><th>Product Name &nbsp&nbsp<button class="dot" title="Click on the product name to get to modify the description of the selected product">?</button></th><th>Product Short Description</th><th>Product Link</th><th>Edit</th><th>Delete</th>
        </tr>
    </thead>
    <tbody>
        <?php 
        if($count<1){}else
        {
            foreach ($result as $row) {
                ?>
                    ...
                    <td><a href="prlist.php?id=<?php echo $row['p_name'];?>"><?php echo $row["p_name"]; ?></a></td>
                    <td><?php echo $row["p_sdesc"]; ?></td>
